...
AdFit은 `NEXT_PUBLIC_ADFIT_ENABLED=true`와 실제 DAN 광고단위 ID가 있을 때만 요청합니다. localhost, 127.0.0.1, preview, onrender.com, 허용 호스트 외 도메인에서는 광고 요청을 하지 않습니다. 자세한 배치와 콘솔 광고단위 이름은 `docs/adfit-monetization.md`를 기준으로 관리합니다.
