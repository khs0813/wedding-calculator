    ...
    <section>
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">함께 확인하면 좋은 예산 계산기입니다.</p>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            {related.map((calculator) => (
              <Link key={calculator.slug} href={calculator.path} className="group rounded-2xl border border-border p-5 transition hover:border-border hover:bg-secondary">
