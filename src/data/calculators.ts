...
export const calculators: CalculatorConfig[] = [
  {
    ...
    title: "결혼식 예산표·결혼 비용 계산기",
    shortTitle: "결혼 비용 계산기",
    description: "웨딩홀·식대·스드메·예물·혼수·신혼여행 비용을 정리하고 축의금 예상액을 반영한 실제 부담액을 계산하세요.",
    hero: "결혼 전 비용을 웨딩홀부터 혼수까지 한 예산표에 정리하고, 축의금 반영 전후 실제 부담액을 바로 비교하세요.",
    keywords: ["결혼식 예산표", "결혼 비용 계산기", "결혼 전 비용", "결혼 준비 총예산", "결혼식 비용 예산표"],
  ...
  },
  {
    ...
    title: "신혼집 예산표·이사 비용 계산기",
    shortTitle: "신혼집 예산 계산기",
    description: "보증금, 대출, 월세, 중개비, 이사·입주청소, 인테리어, 가전·가구를 나눠 초기 현금과 월 고정비를 계산하세요.",
    hero: "보증금 외에 빠뜨리기 쉬운 입주 초기비용과 월 고정비를 분리해 신혼집 예산표로 확인하세요.",
    keywords: ["신혼집 예산표", "이사 예산 계산기", "신혼집 초기비용", "이사 인테리어 대출 가전 예산", "신혼집 이사 비용"],
    ...
    fields: [
      ...
      { id: "brokerageFee", label: "중개비", type: "money", defaultValue: 0, group: "초기 비용" },
      ...
      { id: "curtainCost", label: "커튼/블라인드 비용", type: "money", defaultValue: 0, group: "초기 비용" },
      { id: "lightingCost", label: "조명 비용", type: "money", defaultValue: 0, group: "초기 비용" },
  ...
  },
  {
    ...
    title: "웨딩홀 보증인원·식대 계산기",
    shortTitle: "웨딩홀 비용 계산기",
    description: "보증 인원과 예상 하객 수, 식대, 대관료, 꽃장식, 부가세·봉사료를 반영해 최소 청구액과 순부담액을 확인하세요.",
    hero: "보증 인원과 실제 하객 수 차이를 기준으로 웨딩홀 식대와 결혼식장 총비용을 비교하세요.",
    keywords: ["결혼식 식사 보증인원 계산기", "웨딩홀 보증인원 계산기", "웨딩홀 식대 계산기", "결혼식장 총비용"],
  ...
  },
  {
    ...
    title: "스드메 예산표·견적 계산기",
    shortTitle: "스드메 비용 계산기",
    description: "스튜디오·드레스·메이크업 기본가에 원본, 헬퍼비, 앨범·액자, 출장비를 더해 실제 스드메 비용을 계산하세요.",
    hero: "스드메 견적표에서 기본 패키지와 원본·헬퍼비·드레스 추가금 같은 옵션을 나눠 최종 합계를 확인하세요.",
    keywords: ["스드메 예산", "스드메 예산표", "스드메 견적표", "스드메 추가금", "스드메 견적표 PDF"],
    ...
    fields: [
      ...
      { id: "earlyStartFee", label: "얼리스타트 비용", type: "money", defaultValue: 0, group: "추가 옵션" },
  ...
  },
  {
    ...
    title: "혼수 예산표·신혼 가전·가구 비용 계산기",
    shortTitle: "혼수 비용 계산기",
    description: "냉장고·세탁기·건조기·TV·에어컨·침대·소파 비용을 입력해 혼수 총액과 필수·선택 품목을 비교하세요.",
    hero: "신혼 가전·가구를 필수 품목과 선택 품목으로 나눠 혼수 예산표를 만들고 목표 예산 초과 여부를 확인하세요.",
    keywords: ["혼수 예산", "혼수 예산표", "혼수 비용 계산기", "신혼집 혼수 비용", "혼수 가전 예산표"],
    ...
    fields: [
      ...
      { id: "fridgeRequired", label: "냉장고 필수 품목", type: "checkbox", defaultValue: true, group: "필수/선택" },
      { id: "washerRequired", label: "세탁기 필수 품목", type: "checkbox", defaultValue: true, group: "필수/선택" },
      { id: "dryerRequired", label: "건조기 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "tvRequired", label: "TV 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "airconRequired", label: "에어컨 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "vacuumRequired", label: "청소기 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "bedRequired", label: "침대 필수 품목", type: "checkbox", defaultValue: true, group: "필수/선택" },
      { id: "sofaRequired", label: "소파 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "diningTableRequired", label: "식탁 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "closetRequired", label: "옷장 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "curtainRequired", label: "커튼/블라인드 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "kitchenwareRequired", label: "주방용품 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "smallAppliancesRequired", label: "생활가전 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" },
      { id: "etcRequired", label: "기타 비용 필수 품목", type: "checkbox", defaultValue: false, group: "필수/선택" }
    ],
    faqs: [
